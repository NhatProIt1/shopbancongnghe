...
<!-- font-awesome icons -->
<link rel="stylesheet" href="{{asset('cpublic/backend/ss/font.css')}}" type="text/css"/>
<link href="{{asset('public/backend/css/font-awesome.css')}}" rel="stylesheet"> 
<link rel="{{asset('stylesheet" href="public/backend/css/morris.css')}}" type="text/css"/>
<!-- calendar -->
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>Trần Đức Nhật | Design by <a href="http://w3layouts.com">W3layouts</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
